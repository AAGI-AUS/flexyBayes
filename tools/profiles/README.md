...
| `stress` | `FLEXYBAYES_RUN_STRESS=true Rscript flexyBayes/tools/profiles/stress.R` | Backend fidelity: the brms / INLA optional full-MCMC probes (stress-gated, skipped on CRAN/CI) reproduce their reference posteriors within Monte-Carlo tolerance. |
