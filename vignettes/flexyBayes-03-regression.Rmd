---
title: "Tutorial 03: Foundational regression: linear models, random effects, and mgcv smooths"
date: "2026-06-06"
output:
...
![plot of chunk smooth-predict](flexyBayes-03-regression-figs/smooth-predict-1.png)
...
`te()`, `ti()`, and `t2()` are deferred to a future release.
...
against the `mgcv::predict.gam()` reference.
