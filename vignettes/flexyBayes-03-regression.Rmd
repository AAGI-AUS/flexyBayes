...
#> -- Fixed effects (posterior mean, 95% credible interval) --------
#>               term estimate std.error conf.low conf.high
#>        (Intercept) 101.6928    7.1572  87.5994  115.7510
#>        genPeatland   7.0710    7.3636  -7.4618   21.5109
#>        genSvansota  -4.0060    7.3623 -18.5202   10.4473
#>           genTrebi  22.2746    7.3664   7.7144   36.6979
#>          genVelvet   3.8102    7.3632 -10.7170   18.2540
#>          envDuluth -23.8293    7.9449 -39.3642   -8.1097
#>     envGrandRapids -26.0303    7.9457 -41.5629  -10.3055
#>          envMorris  -2.1376    7.9392 -17.6976   13.5343
#>  envUniversityFarm -14.1274    7.9420 -29.6728    1.5702
#>          envWaseca  27.5279    7.9359  11.9246   43.1436
#> 
#> -- Variance components (95% credible interval) ------------------
#> Estimate = posterior mean (not REML). Prior column is the prior that was used.
#>  component estimate std.error conf.low conf.high                         prior
#>      sigma  18.9144    1.8783  15.6662    23.027 uniform(lower=0, upper=137.7)
#>  note
#>      
#> 
#> -- Convergence -----------------------------------------------
#>   Engine    : INLA nested Laplace approximation
#>   Mode status: 0 (0 = converged)
#>   Marginal log-likelihood: -125.774
#>   Largest symmetric KLD between the Gaussian approximation and the
...
#> -- Fixed effects (posterior mean, 95% credible interval) --------
#>         term estimate std.error conf.low conf.high
#>  (Intercept) 251.1189   10.3804 230.9727  272.4185
#>         Days  10.4715    0.7953   8.8768   12.0252
#> 
#> -- Variance components (95% credible interval) ------------------
#> Estimate = posterior mean (not REML). Prior column is the prior that was used.
#>   component estimate std.error conf.low conf.high                         prior
#>  sd_Subject  40.5211    8.3673  27.7156   60.3144 uniform(lower=0, upper=281.6)
#>       sigma  31.2557    1.7590  28.0594   34.9644 uniform(lower=0, upper=281.6)
#>  note
#>      
#>      
#> 
...
#> -- Fixed effects (posterior mean, 95% credible interval) --------
#>         term estimate std.error conf.low conf.high
#>  (Intercept)   0.3327     0.038   0.2581    0.4074
#> 
#> -- Variance components (95% credible interval) ------------------
#> Estimate = posterior mean (not REML). Prior column is the prior that was used.
#>  component estimate std.error conf.low conf.high                        prior
#>      sigma   0.3388    0.0298   0.2849    0.4019 uniform(lower=0, upper=3.45)
#>       sd_x   0.8523    0.2383   0.4910    1.4210               engine default
#>  note
#>      
#>      
#> 
...
#>   Engine    : INLA nested Laplace approximation
#>   Mode status: 0 (0 = converged)
#>   Marginal log-likelihood: -375.275
#>   Largest symmetric KLD between the Gaussian approximation and the
#>   corrected marginal: 1.15e-07
#>   Numerical confirm: PASS
```
