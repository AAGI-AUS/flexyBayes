...
#> -- Fixed effects (posterior mean, 95% credible interval) --------
#>               term estimate std.error conf.low conf.high
#>        (Intercept) 101.6955    7.1353  87.6455  115.7104
#>        genPeatland   7.0777    7.3398  -7.4078   21.4706
#>        genSvansota  -4.0017    7.3385 -18.4685   10.4047
#>           genTrebi  22.2844    7.3425   7.7716   36.6609
#>          genVelvet   3.8162    7.3393 -10.6637   18.2130
#>          envDuluth -23.8429    7.9199 -39.3287   -8.1730
#>     envGrandRapids -26.0444    7.9207 -41.5281  -10.3695
#>          envMorris  -2.1459    7.9142 -17.6567   13.4764
#>  envUniversityFarm -14.1386    7.9170 -29.6349    1.5093
#>          envWaseca  27.5269    7.9109  11.9730   43.0933
#> 
#> -- Variance components (95% credible interval) ------------------
#> Estimate = posterior mean (not REML). Prior column is the prior that was used.
#>  component estimate std.error conf.low conf.high                         prior
#>      sigma  18.9124    1.8777  15.6665   23.0271 uniform(lower=0, upper=137.7)
#>  note
#>      
#> 
#> -- Convergence -----------------------------------------------
#>   Engine    : INLA nested Laplace approximation
#>   Mode status: 0 (0 = converged)
#>   Marginal log-likelihood: -125.779
#>   Largest symmetric KLD between the Gaussian approximation and the
...
#> -- Fixed effects (posterior mean, 95% credible interval) --------
#>         term estimate std.error conf.low conf.high
#>  (Intercept) 251.4786    6.6693 238.3864  264.5731
#>         Days  10.4510    1.2490   7.9987   12.9027
#> 
#> -- Variance components (95% credible interval) ------------------
#> Estimate = posterior mean (not REML). Prior column is the prior that was used.
#>  component estimate std.error conf.low conf.high                         prior
#>      sigma  47.9976    2.5587  43.2946    53.374 uniform(lower=0, upper=281.6)
#>  note
#>      
#> 
...
#>   Engine    : INLA nested Laplace approximation
#>   Mode status: 0 (0 = converged)
#>   Marginal log-likelihood: -954.669
#>   Largest symmetric KLD between the Gaussian approximation and the
#>   corrected marginal: 2.57e-09
...
#> -- Fixed effects (posterior mean, 95% credible interval) --------
#>         term estimate std.error conf.low conf.high
#>  (Intercept) 250.5617   10.4213 229.8263  270.8258
#>         Days  10.4804    0.8173   8.8745   12.0607
#> 
#> -- Variance components (95% credible interval) ------------------
#> Estimate = posterior mean (not REML). Prior column is the prior that was used.
#>   component estimate std.error conf.low conf.high                         prior
#>  sd_Subject  40.4114    8.2064  27.9229   59.5333 uniform(lower=0, upper=281.6)
#>       sigma  31.2399    1.7469  28.0246   34.9257 uniform(lower=0, upper=281.6)
#>  note
#>      
#>      
#> 
...
#>                                         0.975quant    mode
#> Precision for the Gaussian observations    14.4296 10.1463
