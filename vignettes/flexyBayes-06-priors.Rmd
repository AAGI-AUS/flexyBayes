...
> underneath; brms (Stan HMC) does not share the failure mode. The
...
#> default    40.68902  27.13632   58.18628
#> halfnormal 16.90644  14.53982   19.50031
#> legacy     34.48694  24.91319   48.66854
```
...
standard-deviation scale; INLA receives a `pc.prec` block tuned to
...
per-backend, not universally; brms in particular does not yet
...
genotype-by-environment section of the *formula surface* vignette) -- it is simply not wired into
`fb_prior()` yet.
...
#> [22] knitr_1.51             bridgesampling_1.2-1   pkgbuild_1.4.8        
#> [25] classInt_0.4-11        curl_7.0.0             plyr_1.8.9            
#> [28] RColorBrewer_1.1-3     multcomp_1.4-29        abind_1.4-8           
#> [31] KernSmooth_2.23-26     withr_3.0.2            grid_4.5.2            
#> [34] stats4_4.5.2           xtable_1.8-8           e1071_1.7-17          
#> [37] colorspace_2.1-2       future_1.70.0          inline_0.3.21         
...
#> [85] rstantools_2.6.0       class_7.3-23           Rcpp_1.1.1-1.1        
#> [88] coda_0.19-4.1          gridExtra_2.3          nlme_3.1-168          
#> [91] checkmate_2.3.4        xfun_0.57              zoo_1.8-15            
#> [94] pkgconfig_2.0.3
```
