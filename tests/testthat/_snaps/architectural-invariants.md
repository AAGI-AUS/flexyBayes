...
# the registry key inventory is stable (snapshot)
    ...
    Output
      ...
      [17] "dsum_structured_inner_unsupported"            
      [18] "engine_pin_backend_conflict"                  
      [19] "fa_rank_exceeds_dim"                          
      [20] "fa_rank_invalid"                              
      [21] "fb_cov_missing_matrix"                        
      [22] "fb_cov_type_unknown"                          
      [23] "formula_not_two_sided"                        
      [24] "grammar_brms_known_matrices_unsupported"      
      [25] "grammar_brms_with_asreml_terms"               
      [26] "gretaR_below_version_floor"                   
      [27] "gretaR_cannot_represent_structured_cov"       
      [28] "gretaR_family_unsupported"                    
      [29] "gretaR_not_installed"                         
      [30] "gretaR_random_group_not_in_data"              
      [31] "gretaR_random_term_type_unsupported"          
      [32] "heterogeneous_residual_factor_not_in_cell_key"
      [33] "known_matrices_data_name_collision"           
      [34] "known_matrix_dim_mismatch"                    
      [35] "known_matrix_dimnames_mismatch"               
      [36] "known_matrix_level_mismatch"                  
      [37] "low_rank_rank_exceeds_basis"                  
      [38] "low_rank_rank_invalid"                        
      [39] "low_rank_requires_greta"                      
      [40] "low_rank_scheme_required"                     
      [41] "native_greta_requires_greta_backend"          
      [42] "precision_not_in_known_matrices"              
      [43] "precision_not_positive_definite"              
      [44] "precision_not_square"                         
      [45] "precision_not_symmetric"                      
      [46] "predict_kernel_invalid_include"               
      [47] "representation_unknown_for_preflight"         
      [48] "residual_type_unsupported_for_aggregation"    
      [49] "response_not_in_data"                         
      [50] "review_code_backend_unsupported"              
      [51] "smooth_variable_not_in_data"                  
      [52] "stan_cannot_represent_structured_cov"         
      [53] "tensor_smooth_unsupported"                    
      [54] "unsupported_family"                           
      [55] "vm_redundant_specification"                   
